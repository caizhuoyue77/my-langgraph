...
async def google_news_science_iter(language: str, max_items: int) -> dict:
    """
...
def google_news_science(language: str = "en-US", max_items: int = 5) -> dict:
    """
    ...
    """
    return asyncio.run(google_news_science_iter(language, max_items))

if __name__ == "__main__":
    news_language = "en-US"  # Replace with your desired language code
    max_items = 5  # Replace with your desired number of items
    google_news_results = google_news_science(news_language, max_items)
