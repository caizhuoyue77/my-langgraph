...
async def weather_forcast_3d_iter(input: str):
...
def weather_forcast_3d(location: str):
    return asyncio.run(weather_forcast_3d_iter(location))
...
if __name__ == "__main__":
    result = weather_forcast_3d("101040100")
    print("答案:",result)