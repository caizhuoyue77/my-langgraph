...
def searchjobs(location: str, offset: int, keyword: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://indeed-jobs-api-sweden.p.rapidapi.com/indeed-se/"
