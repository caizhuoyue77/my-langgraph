...
def search_trips(from_id: str, date: str, time: str, passenger0_age: int, to_id: str, passenger2_discount: str=None, passenger4_age: int=None, passenger3_discount: str=None, locale: str=None, passenger2_age: int=None, passenger1_discount: str=None, passenger1_age: int=None, passenger4_discount: str=None, passenger3_age: int=None, passenger0_discount: str=None, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Find trips between two stations"
    from_id: Departure id
        date: Travel date in format DD.MM.YYYY
        time: Travel time
        passenger0_age: Age of the fist passenger
        to_id: Arrival id
    ...
    """
    url = f"https://sbb-suisse-railway.p.rapidapi.com/trips"
...
def autocomplete(query: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Search for train and public transport stations in Switzerland and across Europe"
    query: Query parameter
        
    """
    url = f"https://sbb-suisse-railway.p.rapidapi.com/autocomplete"
